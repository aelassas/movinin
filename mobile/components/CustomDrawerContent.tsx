      ...
      <ScrollView contentContainerStyle={styles.drawer}>
        <View style={styles.menuSection}>
          ...
          <Pressable
            ...
            onPress={() => navigateTo('/')}
          >
            <MaterialIcons name="home" size={24} color={pathname === '/' ? '#0D63C9' : 'rgba(0, 0, 0, 0.54)'} />
          ...
          {loggedIn && (
            ...
            >
              <MaterialIcons name="event-seat" size={24} color={pathname === '/bookings' ? '#0D63C9' : 'rgba(0, 0, 0, 0.54)'} />
          ...
          >
            <MaterialIcons name="info" size={24} color={pathname === '/about' ? '#0D63C9' : 'rgba(0, 0, 0, 0.54)'} />
          ...
          >
            <MaterialIcons name="description" size={24} color={pathname === '/tos' ? '#0D63C9' : 'rgba(0, 0, 0, 0.54)'} />
          ...
          >
            <MaterialIcons name="mail" size={24} color={pathname === '/contact' ? '#0D63C9' : 'rgba(0, 0, 0, 0.54)'} />
          ...
          {loggedIn && (
            ...
            >
              <MaterialIcons name="settings" size={24} color={pathname === '/settings' ? '#0D63C9' : 'rgba(0, 0, 0, 0.54)'} />
          ...
          {!loggedIn && (
            ...
            >
              <MaterialIcons name="login" size={24} color={pathname === '/sign-in' ? '#0D63C9' : 'rgba(0, 0, 0, 0.54)'} />
