...
const Env = {
  ...
  AGENCY_IMAGE_WIDTH: Number.parseInt(String(process.env.REACT_APP_MI_COMAPANY_IMAGE_WIDTH), 10) || 60,
  AGENCY_IMAGE_HEIGHT: Number.parseInt(String(process.env.REACT_APP_MI_COMAPANY_IMAGE_HEIGHT), 10) || 30,
