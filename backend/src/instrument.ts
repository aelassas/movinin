...
const enableSentry = process.env.MI_ENABLE_SENTRY?.trim().toLowerCase() === 'true'
const dsn = process.env.MI_SENTRY_DSN_BACKEND?.trim()
const rawRate = process.env.MI_SENTRY_TRACES_SAMPLE_RATE?.trim()
