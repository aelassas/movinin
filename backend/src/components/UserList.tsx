...
const UserList = (
  ...
  const [types, setTypes] = useState<movininTypes.UserType[]>(userListTypes || [])
  ...
  const getColumns = (user: movininTypes.User) => {
    const columns = [
      {
        field: 'fullName',
      ...
      },
      {
        ...
        renderCell: (params: any) => {
          ...
          return user.type === movininTypes.RecordType.Admin || _user.agency === user._id ? (
            <div>
